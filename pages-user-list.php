...
<?php include("php/pages-user-list-get.php") ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Kullanıcı</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body bg-inverse" style="background: url(../assets/images/background/user-info.jpg) / cover;">
                                <h4 class="text-white card-title">Kullanıcı Listesi</h4>
                                <h6 class="card-subtitle text-white m-0 op-5">Tüm Kullanıcılar</h6>
                            </div>
                            <div class="card-body">
                                <div class="message-box contact-box">                                    
                                    <div class="message-widget contact-widget">
                                        <?php 
                                            echo $pagesUserListGet->getAllUser();
                                        ?>                                    
                                    </div>
                                </div>
                            </div>
